...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _12774_archive_1.so
_12774_archive_1.so : archive.159/_12774_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_12774_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_12774_archive_1.so $@
...
CU_UDP_OBJS = \
objs/udps/uYEPC.o objs/udps/U7Vwg.o objs/udps/exIG1.o objs/udps/Cpxa2.o 
